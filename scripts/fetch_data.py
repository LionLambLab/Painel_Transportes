...
OUTPUT_PATH = os.path.join(os.path.dirname(**file**), ‘..’, ‘data’, ‘indicators.json’)
...
def *anp_fetch_latest_weekly():
“””
Constrói a URL do xlsx semanal da ANP baseada nas datas.
Padrão confirmado: /arquivos-lpc/{ano}/resumo_semanal_lpc*{YYYY-MM-DD}_{YYYY-MM-DD}.xlsx
